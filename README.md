...
The box model consists of Content, Borders, Padding, and Margin.

4. While using flexbox, what axis does the following property work on: ```align-items: center```?

Whereas justify contents work on the main axis align items works on the cross axis.

5. Explain why git is valuable to a team of developers.

Git is important to developers because it helps them keep track of 
projects that they are working on. It allows version control. It allows several 
developers to work on the same project by way of branches. It allows clone, fetch,add files, commit changes and pushing to Github. On the github page, a pull request can be made. Collaborator and reviewer can can merge branches into master.
